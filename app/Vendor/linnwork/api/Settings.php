...
public static function GetXmlSetting($name,$category,$ApiToken, $ApiServer)
{
 return json_decode(Factory::GetResponse("Settings/GetXmlSetting", "name=" . $name . "&category=" . $category . "", $ApiToken, $ApiServer)); 
} 
}
?>