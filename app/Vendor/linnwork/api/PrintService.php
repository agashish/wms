...
{ 
	...
	public static function DownloadVirtualPrinterClient($ApiToken, $ApiServer)
	{
	 return json_decode(Factory::GetResponse("PrintService/DownloadVirtualPrinterClient", "", $ApiToken, $ApiServer)); 
	} 
}
?>
