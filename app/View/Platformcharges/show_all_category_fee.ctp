							...
							<div class="panel no-border ">
                                ...
                                <div class="panel-body no-padding-top bg-white">											
											...
											<tr role="row">
												...
												<th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Warehouse Name: activate to sort column descending">Max Fee (Ebay) </th>
                                    ...
                                    <?php $i = 1; foreach($AllCatFeeDeatils as $AllCatFeeDeatil) { 
										?>
                                            <tr class="odd">
												...
												<td class="sorting_1"><?php print $AllCatFeeDeatil['AmazonFee']['max_fee']; ?></td>                                                
