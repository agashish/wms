<div class="rightside bg-grey-100">
    <div class="page-head bg-grey-100">        
        <h1 class="page-title">Add Category Fee</h1>
				<div class="submenu">
					<div class="navbar-header">
						<ul class="nav navbar-nav pull-left">
							<li>
								<a class="switch btn btn-success" href="/wms/JijGroup/ShowAllCategoryFee" data-toggle="modal" data-target=""><i class=""></i> Show Category Fee </a>
							</li>
						</ul>
					</div>
				</div>
									...
									<label for="username" class="control-label col-lg-3">Platform</label>                                        
									 <div class="col-lg-6">                                            
									   <?php
											...
											if( count( $platform ) > 0 )
											print $this->form->input( 'AmazonFee.platform', array( 'type'=>'select', 'empty'=>'Choose Platform','options'=>$platform,'class'=>'plateform form-control','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false) );
									  ?>  
									</div>
								 </div>
								 
								 <div class="amazon_category form-group" style = "display:none;" >
									<label for="username" class="control-label col-lg-3">Amazon Category</label>                                        
									 <div class="col-lg-6">                                            
									   <?php
											if( count( $amazonCategories ) > 0 )
											print $this->form->input( 'AmazonFee.amazon_map_id', array( 'type'=>'select', 'empty'=>'Choose Amazon Category','options'=>$amazonCategories,'class'=>'form-control','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false ) );
									  ?>  
									</div>
								 </div>
								  ...
								  <div class="max_fee form-group" style="display:none;">
									<label for="username" class="control-label col-lg-3">Max fee (Ebay)</label>                                        
									 <div class="col-lg-6">                                            
									   <?php
											print $this->form->input( 'AmazonFee.max_fee', array( 'type'=>'text', 'class'=>'form-control','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false) );
									   ?> 
									</div>
								 </div>
...
$( document ).ready(function() {
	if($('.plateform').val() == 'Ebay')
	{
		$('.amazon_category').show();
		$('.max_fee').show();
		$('.ref_fee').hide();
	}
	
	$('body').on('change', '.plateform', function(){
