								...
								<div class="tab-pane" id="orange">
								  <div class="panel-body padding-bottom-40">
									<div class="form-group">
									  ...
									  <div class="col-lg-7">                                            
										<?php
										  print $this->form->input( 'ClientContact.0.id', array( 'type'=>'hidden', 'name' => 'data[ClientContact][0][id]') );
										  print $this->form->input( 'ClientContact.0.client_id', array( 'type'=>'hidden', 'name' => 'data[ClientContact][0][client_id]') );
								...
								<div class="tab-pane" id="yellow">
								  <div class="panel-body padding-bottom-40">
									<div class="form-group">
									  ...
									  <div class="col-lg-7">                                            
										<?php
										  print $this->form->input( 'ClientContact.1.id', array( 'type'=>'hidden', 'name' => 'data[ClientContact][1][id]' ) );
										  print $this->form->input( 'ClientContact.1.client_id', array( 'type'=>'hidden', 'name' => 'data[ClientContact][1][client_id]') );
								...
								<div class="tab-pane" id="green">
								  <div class="panel-body padding-bottom-40">
									<div class="form-group">
									  ...
									  <div class="col-lg-7">                                            
										<?php
										  print $this->form->input( 'ClientContact.2.id', array( 'type'=>'hidden', 'name' => 'data[ClientContact][2][id]' ) );
										  print $this->form->input( 'ClientContact.2.client_id', array( 'type'=>'hidden', 'name' => 'data[ClientContact][2][client_id]') );
