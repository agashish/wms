    ...
    <div class="page-head bg-grey-100">        
		...
		<div class="container-fluid">
				...
				<?php
					...
					if(isset($this->request->data['PostalServiceDesc']['id']) && $this->request->data['PostalServiceDesc']['id'] != '')
					{
						print $this->form->input( 'PostalServiceDesc.id', array( 'type'=>'hidden', 'value' => $this->request->data['PostalServiceDesc']['id'] ) );
					}
				?>
                    ...
                    <div class="row">
									  ...
									  <div class="form-group" >
										...
										<div class="col-lg-7">                                            
										   <?php
												...
												print $this->form->input( 'PostalServiceDesc.delevery_country', array( 'type'=>'select', 'empty'=>'Choose Country','options'=>$CountryList,'class'=>'form-control','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false) );
										   ?> 
										</div>
									  </div>
									  ...
									  <div class="form-group" >
										...
										<div class="col-lg-7">                                            
										   <?php
												...
												print $this->form->input( 'PostalServiceDesc.postal_provider_id', array( 'type'=>'select', 'empty'=>'Choose Postal Provider','options'=>$providerlist,'class'=>'form-control','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false) );
										   ?> 
										</div>
									  </div>
							 ...
							 <div class="col-lg-4">
									  ...
									  <div class="form-group" >
										...
										<div class="col-lg-7">                                            
										   <?php
												$manifest	=	array('Yes' => 'Yes', 'No'=>'No', 'Invoice' => 'Invoice');
												if( count( $manifest ) > 0 )
							 ...
							 <div class="col-lg-4">
									...
									<div class="form-group" >
										<label for="username" class="control-label col-lg-5">Custom Country</label>                                        
										  <div class="col-lg-7">                                            
											   <?php
													if( count( $CountryList ) > 0 )
													print $this->form->input( 'PostalServiceDesc.custom_country', array( 'type'=>'select', 'empty'=>'Choose Custom Country','options'=>$CountryList,'class'=>'form-control','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false) );
											   ?> 
										  </div>
									</div>
									...
									<div class="form-group" >
										<label for="username" class="control-label col-lg-5">Currency Code</label>                                        
										  <div class="col-lg-7">                                            
											   <?php
													print $this->form->input( 'PostalServiceDesc.lvcr_ccy', array( 'type'=>'text', 'class'=>'form-control','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false) );
											   ?> 
										  </div>
									</div>
						...
						<div class="text-center margin-top-20 padding-top-20 border-top-1 border-grey-100" style="clear:both">                                                                            
                            	<a class="btn bg-orange-500 color-white btn-dark margin-right-10 padding-left-40 padding-right-40" href="/wms/JijGroup/showallmatrix">Go Back</a>
							   	<?php
									...
									echo $this->Form->button( $lebel, array(
										'type' => 'submit',
										'escape' => true,
