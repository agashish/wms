                                ...
                                <div class="panel-body padding-bottom-40 padding-top-40">
                                      <div class="form-group has-error">
                                        ...
                                        <div class="col-lg-7">                                            
                                            ...
                                            ?>
											<small class="help-block">Please fill first name !</small>
                                        </div>
                                      </div>
                                            ...
                                            <div class="col-sm-7">                                               
                                                ...
                                                <?php
                                                    ...
                                                    if( count( $roleArray ) > 0 )
                                                        print $this->form->input( 'User.role_type', array( 'type'=>'select', 'empty'=>'Choose role','options'=>$roleArray,'class'=>'form-control selectpicker','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false ) );
                                                ?>  
