                                            ...
                                            <tr class="odd">
												...
												<td class="  sorting_1 pick_sku" >
													...
													foreach($result->Items as $item)
														{ 
															echo "<b>".$item->OrderItem->quantity."</b> X&nbsp; ".$item->OrderItem->sku ."</br>";
												...
												<td class="  sorting_1">
													<ul id="icons" class="iconButtons">
														...
														<a href="/wms/Linnworksapis/getOrderDetail/<?php echo $result->NumOrderId; ?>" title="Show Order Description" class="btn btn-success btn-xs margin-right-10"><i class="ion-android-desktop"></i></a>
														...
														<a class="loading-image_<?php echo $id; ?>" style="display:none;"><img src="http://localhost/wms/app/webroot/img/image_889915.gif" hight ="20" width="20" /></a>-->
															...
															foreach($result->Items as $item)
																{ 
																	$qty	=	$checkproduct->checkInventery( $item->OrderItem->sku );
																	if($qty == 1)
																	{
																		$instock++;
																	}
                    ...
                    <div class="row">
                        <div class="col-lg-12">
							<table class="table table-bordered table-striped dataTable">
								...
								<td>
								<?php echo number_format($checkproduct->changeCurrency($expressOne->TotalsInfo->TotalCharge, $expressOne->TotalsInfo->Currency), 2, '.' ,''); ?>
								</td>
								<td>
								<?php echo $expressOne->TotalsInfo->TotalCharge; ?>
								</td>
								<td>
								...
								<td>
								<?php echo number_format($checkproduct->changeCurrency($trackedOne->TotalsInfo->TotalCharge, $trackedOne->TotalsInfo->Currency), 2, '.' ,''); ?>
								</td>
								<td>
								<?php echo $trackedOne->TotalsInfo->TotalCharge; ?>
								</td>
								<td>
								...
								<td>
									<?php
										foreach($standerdOne->Items as $item)
										{ 											
								...
								<td>
								<?php echo number_format($checkproduct->changeCurrency( ($item->OrderItem->price * $item->OrderItem->quantity), $standerdOne->TotalsInfo->Currency), 2, '.' ,''); ?>
								</td>
								<td>
								<?php echo $item->OrderItem->price * $item->OrderItem->quantity; ?>
								</td>
								<td>
								<?php echo $standerdOne->TotalsInfo->Currency; ?>
								</td>
								<td><?php 
                    ...
                    <div class="row">
                        <div class="col-lg-12">
							<table class="table table-bordered table-striped dataTable">
								...
								<td>
									<?php										
										foreach($expressTwo->Items as $item)
										{ 
											echo "<b>".$item->OrderItem->quantity."</b> X&nbsp; ".$item->OrderItem->sku ."</br>";
											echo "<input type=hidden class=get_hidden_sku id=" .$item->OrderItem->sku ."  />";
								...
								<td>
								<?php echo number_format($checkproduct->changeCurrency($expressTwo->TotalsInfo->TotalCharge, $expressTwo->TotalsInfo->Currency), 2, '.' ,''); ?>
								</td>
								<td>
								<?php echo $expressTwo->TotalsInfo->TotalCharge; ?>
								</td>
								<td>
								<?php echo $expressTwo->TotalsInfo->Currency; ?>
								</td>
								<td><?php 
								...
								<td>
									<?php
										foreach($trackedTwo->Items as $item)
										{ 
											echo "<b>".$item->OrderItem->quantity."</b> X&nbsp; ".$item->OrderItem->sku ."</br>";
											echo "<input type=hidden class=get_hidden_sku id=" .$item->OrderItem->sku ."  />";
								...
								<td>
								<?php echo number_format($checkproduct->changeCurrency($trackedTwo->TotalsInfo->TotalCharge, $trackedTwo->TotalsInfo->Currency), 2, '.' ,''); ?>
								</td>
								<td>
								<?php echo $trackedTwo->TotalsInfo->TotalCharge; ?>
								</td>
								<td>
								<?php echo $trackedTwo->TotalsInfo->Currency; ?>
								</td>
								<td><?php 
								...
								<td>
									<?php
										foreach($standerdTwo->Items as $item)
										{ 
											echo "<b>".$item->OrderItem->quantity."</b> X&nbsp; ".$item->OrderItem->sku ."</br>";
											echo "<input type=hidden class=get_hidden_sku id=" .$item->OrderItem->sku ."  />";
								...
								<td>
									<?php echo number_format($checkproduct->changeCurrency($standerdTwo->TotalsInfo->TotalCharge, $standerdTwo->TotalsInfo->Currency), 2, '.' ,''); ?>
								</td>
								<td>
								<?php echo $standerdTwo->TotalsInfo->TotalCharge; ?>
								</td>
								<td>
								<?php echo $standerdTwo->TotalsInfo->Currency; ?>
								</td>
					...
					<div class="panel-body" >
						<table>
							...
							<tr>
								...
								<?php echo $item->OrderItem->sku."<br>"; 
								} ?>
								</td>
							</tr>
							<tr>
