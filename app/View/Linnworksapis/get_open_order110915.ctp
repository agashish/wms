							...
							<div class="panel no-border ">
							   ...
							   <div class="panel-body no-padding-top bg-white">
							    <!--<div id="fileToPrint">
                                    ...
                                    <select id="installedPrinterName" name="installedPrinterName"><option>Samsung SCX-3400 Series</option><option>Samsung 3400</option><option>Microsoft XPS Document Writer</option><option>Fax</option></select>
                                    </div>-->
							   ...
							   <!--<a onclick="javascript:jsWebClientPrint.print('useDefaultPrinter=' + $('#useDefaultPrinter').attr('checked') + '&amp;printerName=' + $('#installedPrinterName').val() + '&amp;filetype=' + $('#ddlFileType').val());" class="btn btn-info btn-large">Print File...</a>-->
							   <!--<a href="" class="btn bg-green-500 color-white btn-dark padding-left-40 padding-right-40">Switch</a>-->
				...
				<div class="submenu">
					<div class="navbar-header">
						<ul class="nav navbar-nav pull-left">
							...
							<li>
								<a class="btn btn-xs btn-success" href="/wms/linnworksapis/dispatchConsole" data-toggle="modal" data-target="">Despatch Console</a>
							</li>	
							<li>
								<a href="/wms/linnworksapis" type="submit" class="printorder btn bg-orange-500 color-white btn-dark padding-left-40 padding-right-40" >Go Back</a>
							</li>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body bg-grey-100">
           	<div class="panel" style="clear:both">
					...
					<?php
								//echo  $this->form->create('Linnworksapis', array( 'class'=>'form-horizontal bv-form', 'type'=>'post','id'=>'getFilterOrderCsv','enctype'=>'multipart/form-data'));
								//echo  $this->form->input('Linnworksapis.barcode', array('type'=>'text','class' => 'get_sku_string','index'=>0 ));
								//echo  $this->Form->button('Submit', array('type' => 'submit','escape' => true,'class'=>'download_button add_search_field btn bg-green-500 color-white btn-dark padding-left-40 padding-right-40'));
								//echo  $this->form->end();
							?>
				</div>
...
<script type="text/javascript">
    $("#ddlFileType").change(function () {
        ...
        if (s == 'DOC') $("#ifPreview").attr("src", "http://docs.google.com/gview?url=http://webclientprintphp.azurewebsites.net/files/LoremIpsum.doc&embedded=true");
        if (s == 'PDF') $("#ifPreview").attr("src", "http://docs.google.com/gview?url=http://webclientprintphp.azurewebsites.net/files/LoremIpsum.pdf&embedded=true");
        if (s == 'TXT') $("#ifPreview").attr("src", "http://docs.google.com/gview?url=http://webclientprintphp.azurewebsites.net/files/LoremIpsum.txt&embedded=true");
        if (s == 'TIF') $("#ifPreview").attr("src", "http://docs.google.com/gview?url=http://webclientprintphp.azurewebsites.net/files/patent2pages.tif&embedded=true");
        if (s == 'XLS') $("#ifPreview").attr("src", "http://docs.google.com/gview?url=http://webclientprintphp.azurewebsites.net/files/SampleSheet.xls&embedded=true");
        if (s == 'JPG') $("#ifPreview").attr("src", "http://webclientprintphp.azurewebsites.net/files/penguins300dpi.jpg");
        if (s == 'PNG') $("#ifPreview").attr("src", "http://webclientprintphp.azurewebsites.net/files/SamplePngImage.png");
    }).change();
</script>
-->
