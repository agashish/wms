...
//echo "<pre>";
//print_r($parser);
//echo $parser->GetLocationsResponse->GetLocationsResult->DataObj->StockItemLocation[0]->LocationName;
//exit;
?>
						       ...
						       <div class="panel-body no-padding-top bg-white">											
									...
									<thead>
										<tr role="row">
											...
											<th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Brand: activate to sort column descending">Location Name</th>
										</tr>
									</thead>
									<tbody role="alert" aria-live="polite" aria-relevant="all">
                                            <?php $i = 1;
												foreach($parser->GetLocationsResponse->GetLocationsResult->DataObj->StockItemLocation as $location)
													{ 
                                            ?>
                                            <tr class="odd">
												<td class="  sorting_1"><?php echo $i; ?></td>
												<td class="  sorting_1"><?php echo $location->LocationName; ?></td>
										    </tr>
                                            <?php $i++; } ?>
                                      </tbody>
									</table>		
