                        ...
                        <div class="col-lg-12">
							<div class="panel no-border ">
									...
									<div class="panel-title bg-white no-border">
										<?php
											print $this->form->create( 'Linnworksfilter', array( 'class'=>'bv-form', 'type'=>'post','id'=>'getFilterOrder','enctype'=>'multipart/form-data' ));
											?>
<div class="row">											
											<div class="col-lg-2 form-group">
												<label for="username" class="control-label col-lg-12">Order Type</label>                                        
												<div class="col-lg-12">                                            
													<?php
											...
											<div class="col-lg-2 form-group" style="display:none;">
												<label for="username" class="control-label col-lg-12">Location</label>                                        
												<div class="col-lg-12">                                            
													<?php
											...
											<div class="col-lg-2 form-group">
												<label for="username" class="control-label col-lg-12">Source</label>                                        
												<div class="col-lg-12">                                            
													<?php
											...
											<div class="col-lg-2 form-group">
												<label for="username" class="control-label col-lg-12">Subsource</label>                                        
												<div class="col-lg-12">                                            
													<?php
											...
											<div class="col-lg-2 form-group">
												<label for="username" class="control-label col-lg-12">From</label>  
												<div class="col-lg-12">                                            
												<?php
											...
											<div class="col-lg-2 form-group">
												<label for="username" class="control-label col-lg-12">To</label>                                        
												<div class="col-lg-12">                                            
												<?php
											...
											<div class="col-lg-2 form-group">
												<label for="username" class="control-label col-lg-12">Order by ID</label>                                        
												<div class="col-lg-12">                                            
													<?php
											...
											<?php
													if( isset( $data['Linnworksapi']['order_type'] ) && $data['Linnworksapi']['order_type'] == 0 )
													{
														...
														echo  $this->Form->button('Export to CSV', array('type' => 'submit','escape' => true,'class'=>'add_search_field btn bg-green-500 color-white btn-dark padding-left-40 padding-right-40'));
													}
