            ...
            <div class="col-lg-12">
			  ...
			  <div class="panel-title">
					...
					<div class="panel-tools">
						...
						<a href="javascript:void(0);"  for = "<?php echo $id; ?>" class="printlable btn bg-orange-500 color-white btn-dark"  style="opacity : .5;" >Print Label</a>
						<a href="javascript:void(0);"  for = "<?php echo $id; ?>" class="printorder btn bg-orange-500 color-white btn-dark"  style="opacity : .5;" >Print Slip</a>
              ...
              <div class="barcodemsg" ></div>                            
					...
					<table class="table table-bordered table-striped dataTable" >
							...
							<tr class="quantity" id="<?php echo $detail['NumOrderId']; ?>" >
									...
									<td for = "<?php echo $i ?>" id = "barco_<?php echo $item['BarcodeNumber']; ?>" class="upqty_<?php echo $i; ?>_<?php echo $detail['NumOrderId']; ?>" id="aaa"><?php echo $qty; ?></td>
									<td for = "<?php echo $i ?>" class="qty_<?php echo $i; ?>_<?php echo $detail['NumOrderId']; ?>"><?php echo $item['Quantity']; ?></td>
