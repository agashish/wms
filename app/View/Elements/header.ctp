...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
				...
				<li class="dropdown dropdown-inverse">
                    ...
                    <ul class="dropdown-menu multi-level">
						...
						<li class="dropdown-submenu">
							...
							<ul class="dropdown-menu">
							<!--<li><a href="/wms/JijGroup/Generic/Order/GetOrder">Orders</a></li>-->
		...
		<div class="navbar-right">
				<ul class="nav navbar-nav">
					...
					<a title="Log Out" href="<?php print Router::url(array('controller' => 'users', 'action' => 'logout')); ?>" class="button"><i class="ion-log-out"></i></a>
