...
<div class="navbar-header">
				<ul class="nav navbar-nav pull-left">
					...
					<li class="dropdown dropdown-inverse">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" ><i class="fa fa-map-marker"></i> <span>Countries</span></a>
						<ul class="dropdown-menu">
					...
					<!--Delevery Matrix-->
					<li class="dropdown dropdown-inverse">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" ><i class="fa fa-shirtsinbulk"></i> <span>Delivery Matrix</span></a>
						<ul class="dropdown-menu">
