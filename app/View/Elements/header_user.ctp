...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav">
				<li class="dropdown dropdown-inverse">
                    ...
                    <ul class="dropdown-menu multi-level">
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="ion-ios-world"></i> <span>Country</span></a>
                            <!--<ul class="dropdown-menu">
						...
						<li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="ion-earth"></i> <span>State</span></a>
                            <!--<ul class="dropdown-menu">
						...
						<li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="ion-ios-navigate"></i> <span>City</span></a>
                            <!--<ul class="dropdown-menu">
					...
					<li class="dropdown dropdown-inverse">
						...
						<!--<ul class="dropdown-menu">
							...
							<li><a href="/wms/cronjobs/openRack">Add Racks(Label Print)</a></li>
						</ul>-->
					</li>
					<li class="dropdown dropdown-inverse">
                    ...
                    <ul class="dropdown-menu multi-level">
                        ...
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="ion-android-person-add"></i> <span>Check In</span></a>
                            <ul class="dropdown-menu">
							<li><a href="/wms/JijGroup/CheckIn/Stock">Stock Update</a></li>	
							</ul>
                        </li>
						<li class="dropdown-submenu">
						...
						<!--<a href="/wms/Productattributes/addAttribute"  ><i class="fa fa-buysellads"></i> <span>Product Attributes</span></a>-->
						<a href="#"  ><i class="fa fa-buysellads"></i> <span>Product Attributes</span></a>
						</li>
						<li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" ><i class="fa fa-shirtsinbulk"></i> <span>Product</span></a>
							<ul class="dropdown-menu">
							<li><a href="/wms/showAllProduct">Show Product</a></li>
							<li><a href="/wms/addProductattributeset">Add Product</a></li> 	
							<li><a href="/wms/JijGroup/UploadProducts">Upload Product</a></li> 	
							<li><a href="/wms/products/ProductDetail">Product Detail</a></li> 	
							</ul>
                        </li>
						<li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" ><i class="fa fa-shirtsinbulk"></i> <span>Packaging Types</span></a>
							<ul class="dropdown-menu">
							<li><a href="/wms/JijGroup/Packaging/Type/On">Add Packaging Type</a></li>
							<li><a href="/wms/JijGroup/Packaging/Type/Show">ShowAll Package Types</a></li>
							<li><a href="/wms/JijGroup/Envelope/PackagingType/On">Add Variants by Packaging Types</a></li>
							<li><a href="/wms/JijGroup/Envelope/PackagingEnvelopes/Show">ShowAll Variants</a></li>							
							</ul>
                        </li>
                    </ul>
                </li>
					<li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-plug"></i> <span>Linnworks API</span> <b class="caret"></b></a>
                    <!--<ul class="dropdown-menu multi-level">
                        <li>
						<a href="/wms/JijGroup/Generic/Category"><i class="ion-merge"></i> <span>Categories</span></a>
						</li>
						<li>
						<a href="/wms/JijGroup/Generic/Store/Location"><i class="fa fa-map-marker"></i> <span>Locations</span></a>
						</li>
						<li>
						<a href="/wms/JijGroup/Generic/Services/Postal"><i class="ion-email"></i> <span>Postal Services</span></a>
						</li>
						<li>
						<a href="/wms/JijGroup/Generic/StockItem"><i class="fa fa-database"></i> <span>Stock Item</span></a>
						</li>
						<li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" ><i class="fa fa-gavel"></i> <span>Order Management</span></a>
							<ul class="dropdown-menu">							
							<li><a href="/wms/JijGroup/Generic/Order/GetOpenFilter">Open Order</a></li> 	
							<li><a href="/wms/JijGroup/Generic/Order/OrderFilter">Order Filter</a></li> 
							<li><a href="/wms/JijGroup/Generic/Status/Order">Order Status</a></li>							
							</ul>
                        </li>
                    </ul>
                </li>
					...
					<li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="ion-grid"></i> <span>Delivery Matrix</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu multi-level">
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="ion-email"></i> <span>Postal Service</span></a>
                            <ul class="dropdown-menu">
							<li><a href="/wms/JijGroup/showallmatrix">Show Postal Service</a></li>
							<li><a href="/wms/JijGroup/DeleveryMatrix">Add Postal Service</a></li> 	
							</ul>
                        </li>
						<li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" ><i class="ion-cube	"></i> <span>Postal Provider</span></a>
							<ul class="dropdown-menu">
							<li><a href="/wms/JijGroup/showallpostalprovider">Show Postal Provider</a></li>	
							<li><a href="/wms/JijGroup/addPostalProvider">Add Postal Provider</a></li>			
							</ul>
                        </li>
					...
					<li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bank"></i> <span>Platform Charges</span> <b class="caret"></b></a>
                    <!--<ul class="dropdown-menu multi-level">
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-amazon"></i> <span>Platform Category</span></a>
                            <ul class="dropdown-menu">
							<li><a href="/wms/JijGroup/ShowAllCategoryFee">Show Category Fee</a></li>
							<li><a href="/wms/JijGroup/AddCategoryFee">Add Category Fee</a></li> 	
							</ul>
                        </li>
                        
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-amazon"></i> <span>Amazon FBA</span></a>
                            <ul class="dropdown-menu">
							<li><a href="/wms/JijGroup/Showallplatformfee">Show FBA Fee</a></li>
							<li><a href="/wms/JijGroup/ShowAllCategoryFee">Add FBA Fee</a></li> 	
							</ul>
                        </li>		
			        </ul>-->
                </li>				
				...
				<!--Start for other-->
				<li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class=""></i> <span>Other</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu multi-level">
                        <!--<li class="">
                            <a href="/wms/JijGroup/ShowCustomers"><span>Customer</span></a>
                        </li>-->		
                        <li class="">
                        
                            <a href="/wms/JijGroup/Sorting"><span>Sorting</span></a>
		...
		<div class="navbar-right">
				<ul class="nav navbar-nav">
				<li>
                    <a title="Settings" href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="ion-gear-a"></i></a>
                    <ul class="dropdown-menu multi-level">
                        <li class="">
                            <a href="/wms/userProfile" ><span>Change Password</span></a>
                        </li>		
			        </ul>
                </li>
...
<!-----------------------------------------------Start Popup for View Rack ----------------------------------------------->	
<div class="modal modal-wide fade pop-up-6" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel-6" aria-hidden="true">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h4 class="modal-title" id="myLargeModalLabel-5">View Rack</h4>
         </div>
         <div class="modal-body bg-grey-100">
