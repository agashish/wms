			...
			<div class="sidebar">
				...
				<div class="title">Navigation</div>
					<ul class="nav-sidebar">
						...
						<li class="">
							<a title="Linnworks API" href="/wms/linnworksapis">
								<i class="fa fa-plug"></i> <span>Linnworks API</span>
							</a>
						</li>
						<li class="">
							<a title="Delivery Matrix" href="/wms/linnworksapis">
