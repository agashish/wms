				...
				<div class="title">Navigation</div>
					<ul class="nav-sidebar">
						...
						<li class="nav-dropdown">
                            ...
                            <ul>
								<li>
								<a href="/wms/JijGroup/Generic/Category"><i class="ion-merge"></i> Categories</a>
								</li>
								<li>
								<a href="/wms/JijGroup/Generic/Store/Location"><i class="fa fa-map-marker"></i> Locations</a>
								</li>
								<li>
								<a href="/wms/JijGroup/Generic/Services/Postal"><i class="ion-email"></i> Postal Services</a>
								</li>
								<li>
								<a href="/wms/JijGroup/Generic/StockItem"><i class="fa fa-database"></i> Stock Item</a>
								</li>
								<li class="nav-dropdown dropdown-submenu"><a title="Brands" href="#">
