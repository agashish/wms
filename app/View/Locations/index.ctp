              ...
              <div class="panel">                            
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            ...
                            <?php
                                print $this->form->create( 'Location', array( 'class'=>'form-horizontal', 'type'=>'post','id'=>'location' ) );
                            ...
                            ?>
                                <div class="panel-body padding-bottom-40 padding-top-40">
                                        ...
                                        <div class="col-lg-7">                                            
                                            <?php
                                                    ...
                                                    if( count( $statusArray ) > 0 )
                                                        print $this->form->input( 'Location.status', array( 'type'=>'select', 'empty'=>'Choose Status','options'=>$statusArray,'class'=>'form-control selectpicker','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false) );
                                            ?>  
                                        </div>
                                      </div>
                                    ...
                                    <div class="text-center margin-top-20 padding-top-20 border-top-1 border-grey-100">                                                                            
									  ...
									  <?php
											echo $this->Form->button('Add County', array(
												'type' => 'submit',
												'escape' => true,
