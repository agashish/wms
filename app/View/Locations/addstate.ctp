                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">                                            
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-lg-7">                                            
                                            <?php
                                                print $this->form->input( 'State.state_name', array( 'type'=>'text','div'=>false,'label'=>false,'class'=>'form-control', 'required'=>false ) );
                                            ?>
                                        </div>
                                      </div>
                                    ...
                                    <div class="text-center margin-top-20 padding-top-20 border-top-1 border-grey-100">                                                                 <?php
									...
									?>           
									  ...
									  <?php
											echo $this->Form->button('Add State', array(
												'type' => 'submit',
												'escape' => true,
