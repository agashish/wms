              ...
              <div class="panel">                            
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            ...
                            <?php
                                print $this->form->create( 'PackageEnvelope', array( 'class'=>'form-horizontal', 'type'=>'post','id'=>'PackageEnvelope' ) );
                                ...
                                <div class="panel-body padding-bottom-40 padding-top-40">
									  ...
									  <div class="form-group">
                                        ...
                                        <?php                                        
                                             ...
                                             print $this->form->input( 'PackageEnvelope.packagetype_id', array( 'type'=>'select', 'empty'=>'Choose Country','options'=>$packageList,'class'=>'form-control location selectpicker','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false) );
                                        ?>  
                                        </div>
                                      </div>	
                                    ...
                                    <div class="text-center margin-top-20 padding-top-20 border-top-1 border-grey-100">                                                                            
                                      <?php
										...
										?>
                                      <?php
											echo $this->Form->button('Add Package Type', array(
												'type' => 'submit',
												'escape' => true,
