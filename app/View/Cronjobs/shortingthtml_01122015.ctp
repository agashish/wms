                                                ...
                                                ?>
                                                                                                                                <div class="col-sm-6 ">
                                                                                                                                                <div class="panel margin-bottom-15 bg-white <?php echo $strFormat; ?>">
                                                                                                                                                                <div class="panel-body padding-5-10">
                                                                                                                                                                                <div class="clearfix ">
                                                                                                                                                                                                <div class="pull-left">
                                                                                                                                                                                                <p class="help-block no-margin">Total</p>
                                                                                                                                                                                                <div class="color-blue-grey-200 font-size-26 font-roboto font-weight-600 line-height-20 customTotal"><?php print $leftService[$icount]['ServiceCounter']['original_counter']; ?></div>
                                                                                                                                                                                                </div>
                                                                                                                                                                                                <div class="pull-left margin-left-30">
                                                                                                                                                                                                <p class="help-block no-margin">Scanned</p>
                                                                                                                                                                                                <div class="color-blue-grey-200 font-size-26 font-roboto font-weight-600 line-height-20 custom">
                                                                                                                                                                                                                <?php                                                                                                                                                                                                                   
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div class="pull-left margin-left-30">
                                                                                                                                                                                                                <p class="help-block no-margin">Bags</p>
                                                                                                                                                                                                                <div class="color-blue-grey-200 font-size-26 font-roboto font-weight-600 line-height-20 customBags customDisplay<?php print $leftService[$icount]['ServiceCounter']['id']; ?>" for="<?php print $leftService[$icount]['ServiceCounter']['id']; ?>">
                                                                                                                                                                                                                                <?php
                                                                                                                                                                                                                                                print $leftService[$icount]['ServiceCounter']['bags'];
                                                                                                                                                                                                                                ?>
                                                                                                                                                                                                                </div>
                                                                                                                                                                                                </div>
                                                                                                                                                                                                <div class="absolute top right margin-right-10">
                                                                                                                                                                                                                <span class="threeDtext font-size-36 color-white"><?php print "A".$indexCounter; ?></span>
                                                                                                                                                                                                </div>
                                                                                                                                                                                </div>
                                                                                                                                                                                <div class="clearfix "><div class="display-block color-blue-grey-200 font-weight-600 margin-top-5"><?php print $leftService[$icount]['ServiceCounter']['service_name']. ' ' . $leftService[$icount]['ServiceCounter']['service_provider'] .'('. $leftService[$icount]['ServiceCounter']['destination'].')'; ?></div>
                                                                                                                                                                                </div>
                                                                                                                                                                </div>
                                                                                                                                                </div><!-- /.panel -->
                                                                                                                                </div>   
                                                                                                                                                ...
                                                                                                                                                <div class="panel margin-bottom-15 bg-white <?php echo $strFormat; ?>">
                                                                                                                                                                <div class="panel-body padding-5-10">
                                                                                                                                                                                <div class="clearfix ">
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div class="pull-left margin-left-30">
                                                                                                                                                                                                                <p class="help-block no-margin">Bags</p>
                                                                                                                                                                                                                <div class="color-blue-grey-200 font-size-26 font-roboto font-weight-600 line-height-20 customBags customDisplay<?php print $leftService[$icount]['ServiceCounter']['id']; ?>" for="<?php print $leftService[$icount]['ServiceCounter']['id']; ?>"><?php print $leftService[$icount]['ServiceCounter']['bags']; ?></div>
                                                                                                                                                                                                </div>
                                                                                                                                                                                                <div class="absolute top right margin-right-10">
                                                                                                                                                                                                                <span class="threeDtext font-size-36 color-white"><?php print "A".$indexCounter; ?></span>
                                                                                                                                                                                                </div>
                                                                                                                                                ...
                                                                                                                                                <div class="panel margin-bottom-15 bg-white <?php echo $strFormat; ?>">
                                                                                                                                                                <div class="panel-body padding-5-10">
                                                                                                                                                                                <div class="clearfix ">
                                                                                                                                                                                                <div class="pull-left">
                                                                                                                                                                                                <p class="help-block no-margin">Total</p>
                                                                                                                                                                                                <div class="color-blue-grey-200 font-size-26 font-roboto font-weight-600 line-height-20 customTotal"><?php print $rightService[$icount]['ServiceCounter']['original_counter']; ?></div>
                                                                                                                                                                                                </div>
                                                                                                                                                                                                <div class="pull-left margin-left-30">
                                                                                                                                                                                                <p class="help-block no-margin">Scanned</p>
                                                                                                                                                                                                <div class="color-blue-grey-200 font-size-26 font-roboto font-weight-600 line-height-20 custom">
                                                                                                                                                                                                ...
                                                                                                                                                                                                <div class="pull-left margin-left-30">
                                                                                                                                                                                                                <p class="help-block no-margin">Bags</p>
                                                                                                                                                                                                                <div class="color-blue-grey-200 font-size-26 font-roboto font-weight-600 line-height-20 customBags customDisplay<?php print $rightService[$icount]['ServiceCounter']['id']; ?>" for="<?php print $rightService[$icount]['ServiceCounter']['id']; ?>"><?php print $rightService[$icount]['ServiceCounter']['bags']; ?></div>
                                                                                                                                                                                                </div>
                                                                                                                                                                                                <div class="absolute top right margin-right-10">
                                                                                                                                                                                                                <span class="threeDtext font-size-36 color-white"><?php print "A".$indexCounter; ?></span>
                                                                                                                                                                                                </div>
                                                                                                                                                                                </div>
                                                                                                                                                                                <div class="clearfix "><div class="display-block color-blue-grey-200 font-weight-600 margin-top-5"><?php print $rightService[$icount]['ServiceCounter']['service_name']. ' ' . $rightService[$icount]['ServiceCounter']['service_provider'] .'('. $rightService[$icount]['ServiceCounter']['destination'].')'; ?></div>
                                                                                                                                                                                </div>
                                                                                                                                                                </div>
                                                                                                                                                </div><!-- /.panel -->
                                                                                                                                </div>
                                                ...
                                                'success'                                : function( msgArray )
                                                                                                                   {                                                                                                                              
                                                                                                                                   ...
                                                                                                                                   {                                                                                                                                              
                                                                                                                                                                ...
                                                                                                                                                                var customIncrementer = $.trim($( 'div.row div.col-sm-6' ).find( 'div.'+msgArray ).find( 'div.custom' ).html());
                                                                                                                                                                ...
                                                                                                                                                                if( customIncrementer == "-" )
                                                                                                                                                                {
                                                                                                                                                                                ...
                                                                                                                                                                                $( 'div.row div.col-sm-6' ).find( 'div.'+msgArray ).find( 'div.custom' ).html("");                                                                                                                                                    
                                                                                                                                                                                $( 'div.row div.col-sm-6' ).find( 'div.'+msgArray ).find( 'div.custom' ).html( customIncrementer );
                                                                                                                                                                                
                                                                                                                                                                                //Blinking Background
                                                                                                                                                                                setTimeout(function ()
                                                                                                                                                                                {
                                                                                                                                                                                                $( 'div.row div.col-sm-6 div.'+msgArray ).removeClass('bg-white').addClass('bg-yellow-400');
