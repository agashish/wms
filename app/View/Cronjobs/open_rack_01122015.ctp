<div class="rightside bg-grey-100">
	...
	<div class="container-fluid">
        <div class="row">
			...
			<div class="row">
				...
				<div class="col-lg-9">
					<div class="panel">
							<div class="panel-title">
								<div class="panel-head">View Rack <button type="submit" class="rackLabelPrint btn bg-green-500 color-white btn-dark">Print</button></div>	
													...
													<div class="level" id="<?php print $rName; ?>">
														...
														?>
																...
																<?php
																	...
																	{
																?>
																		<img src="<?php print '/wms/img/racks/barcodes/'.$newLevlSection.'.png'; ?>" width="50" height="35" />
																<?php
																	}
																?>		
																</div>															
						...
						success 	:	function( data  )
						{
							if( data == 'done' )
							{
								...
								var newRackAdd = '<div id="'+setNewSectionId+'" class="section">';
									...
									newRackAdd += '<img width="50" height="35" src="'+ newImagePath +'">';
								newRackAdd += '</div>';
		...
		<style type="text/css">
			...
			.actionBtn{float:right; width:50px;}	
		</style>
